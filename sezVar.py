...
class SEZ(Variable):
	...
	def __add__(self, other): # v primeru seštevanje, se element doda v seznam
	...
	def __div__(self, other): # pri deljenju z 0 se seznam uredi, pri deljenju z drugimi števili pa se elementi naključno premešajo.
		if int(other) == 0:
			self.value.sort()
			return self
		else:
